...
# Logs go to <exp_root>/results/results_ascal_restart/<domain>/ by default.
#
# Usage:
...
SCRIPT="$EXP_ROOT/scripts/loop_ascal_restart.py"
BENCH_ROOT="${BENCH_ROOT:-$PROJECT_ROOT/benchmarks}"
RESULTS_ROOT="${RESULTS_ROOT:-$EXP_ROOT/results/results_ascal_restart}"
