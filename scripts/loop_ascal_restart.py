...
**Server log file:** by default writes to ``<repo>/results_ascal_restart/<domain>/<problem-stem>.log``
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        metavar="PATH",
        help=(
            "Log path (default: <repo>/results_ascal_restart/<domain>/<problem-stem>.log)."
        ),
    )
    ap.add_argument(
        "--no-log-file",
    ...
    ap.add_argument(
        ...
        help=(
            ...
            "(default: <repo>/results_ascal_restart)."
        ),
    )
    args = ap.parse_args()
    ...
    results_root = (
        ...
        else repo / "results_ascal_restart"
    )
    default_log_file = (
