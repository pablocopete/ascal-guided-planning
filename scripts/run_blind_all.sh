...
# Logs go to <repo>/results_blind/<domain>/ by default.
#
...
SCRIPT="$ROOT/scripts/run_ucs_baseline.py"
BENCH_ROOT="$ROOT/benchmarks"
RESULTS_ROOT="${RESULTS_ROOT:-$ROOT/results_blind}"
...
echo "[run_blind_all] repo=$ROOT benchmarks=$BENCH_ROOT results=$RESULTS_ROOT max_expansions=${MAX_EXPANSIONS} max_wall_sec=${MAX_WALL_SEC} max_concurrent_jobs=$MAX_JOBS total_tasks=${#COMMANDS[@]}" >&2
