(define (domain mixed_f8_p4_u0_v0_d0_a0_n0_a0_b0_n0_f0_problem_problem_problem-domain)
 ...
 (:action board
  :parameters ( ?f1 - floor ?p1 - passenger)
  :precondition (and (lift_at ?f1) (origin ?p1 ?f1))
  :effect (and (boarded ?p1)))
 (:action depart
  :parameters ( ?f1 - floor ?p1 - passenger)
  :precondition (and (lift_at ?f1) (destin ?p1 ?f1) (boarded ?p1))
